...
export const metadata: Metadata = {
  title: '30-Day LinkedIn Content Calendar for Real Estate Agents | MarketingAI',
  description:
    '30 done-for-you LinkedIn post prompts tailored for Australian real estate agents. Instant download, $19 AUD.',
};

export default function RealEstateAgentsContentCalendarPage() {
  const stripeLink = 'https://buy.stripe.com/dRm8wRdjLgkx36z01cbsc03';
      ...
      <section style={{ background: '#1a1a2e' }} className="py-20 px-6 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-xl text-gray-300 mb-8 leading-relaxed">
            30 done-for-you LinkedIn post prompts, crafted specifically for Australian real estate agents.
          </p>
          <a
            href={stripeLink}
      ...
      <section className="py-16 px-6 bg-gray-50">
        <div className="max-w-2xl mx-auto">
          ...
          <ul className="space-y-5">
            {[
              "You know you should be posting on LinkedIn. You just don\u2019t know what to say about property.",
              "You\u2019re posting inconsistently \u2014 or not at all \u2014 while other agents build their personal brand.",
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <ul className="space-y-4">
            {[
              ...
              "4 proven content themes that build trust with buyers and sellers",
              "Best posting times for Australian property audience",
